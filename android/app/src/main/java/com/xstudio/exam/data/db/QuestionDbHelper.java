package com.xstudio.exam.data.db;
...
public class QuestionDbHelper extends SQLiteOpenHelper {
    ...
    private static QuestionDbHelper helper;
    ...
    public static QuestionDbHelper getInstance(Context context) {
        if (helper == null) {
            helper = new QuestionDbHelper(context, DATABASE_NAME, null, DATABASE_VERSION);
        }
    ...
    // 重新初始化整个问题数据库
    public void ReInitQuestionDatabase(List<Question> questions) {
        ...
        for (Question question : questions) {
            ...
            db.replace(TABLE_QUESTION, null, cv);
        }
